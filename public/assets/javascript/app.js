...
//Create the query URL based on a user destination.
//using document.body in case there are any scope problems
$('.volsearch').on('click', function() {
    ...
    depcity=$('#usersOrigin').val().trim();
    console.log(depcity);
    var airportOrigin=cityToAirport[depcity];
    console.log(airportOrigin);
    destcity=$('#usersDestination').val().trim();
